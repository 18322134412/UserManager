...
public IEnumerable<Users> QueryList(int index, int size=10, object wheres=null, string orderField=null, bool isDesc=false)
{
...
#endregion
#region 查询单个模型实体 +Dictionary<string,object> QuerySingleByIdX(string id,object columns)///<summary>
///查询单个模型实体
///</summary>
///<param name=id>key</param>
///<returns>实体</returns>
...
{
return _dao.QuerySingleByIdX(id,columns);
}
#endregion
...
{
return _dao.UpdateById(id, columns);
}
 #endregion
